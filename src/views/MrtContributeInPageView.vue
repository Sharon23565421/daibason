<template>
  <div class="mrtContibuteInPage">
    ...
    <div class="fixCenter part3"  :style="{
      ...
      <div class="content">
        ...
        <article>
          <p>
            榕，<br>
            一座單名的咖啡酒吧，出自門前的老榕樹，翻新老屋創造士林傳說。在這裡，隨著派對聚會與音樂的喧鬧聲，我們聚集了氣味相投的常客老友們， 互相稱之為「榕民」。<br>
    ...
    <div class="fixCenter part4"  :style="{
      ...
      <div class="content">
        ...
        <article>
          <p >
            ...
            榕 RON 團隊為空間注入藝術，為氣氛加入音樂，從餐點翻玩創意， 為情感抒發提供餐酒空間，「榕」合出人與人的交流。
          </p>
        </article>
      </div>
    ...
    <div class="seperate">
      <svg height="10" width="4000">
        <g fill="none">
          <path stroke="#ccc" stroke-width="5" d="M 0,0 l4000,0" stroke-dasharray="10,10"/>
        </g>
      </svg>
    </div>
